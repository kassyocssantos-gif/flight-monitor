...
# origens (gateways BR + cidades do Sul) x destinos (gateways US por regiao)
ORIGINS = ["GRU", "GIG", "BSB", "FLN", "CWB", "NVT", "POA", "CNF"]
DESTS = ["MIA", "MCO", "FLL", "JFK", "EWR", "LAX", "IAH", "ORD"]
# pares relevantes: GRU cobre tudo; demais focam Florida/NY (rotas com preco real)
ROUTES = [("GRU", d) for d in DESTS] + [
    ("GIG", "MIA"), ("GIG", "JFK"), ("GIG", "MCO"), ("GIG", "FLL"),
    ("BSB", "MIA"), ("BSB", "JFK"), ("BSB", "MCO"),
    ("FLN", "MIA"), ("FLN", "MCO"), ("FLN", "JFK"),
    ("CWB", "MIA"), ("CWB", "MCO"),
    ("NVT", "MIA"), ("POA", "MIA"), ("CNF", "MIA"),
    ("VCP", "MIA"), ("VCP", "MCO"), ("VCP", "FLL"), ("VCP", "JFK"),
]
